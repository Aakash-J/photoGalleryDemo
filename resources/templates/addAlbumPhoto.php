...
if(isset($_FILES['upload1'])){
   ...
   if($tmp_name == '')
        ...
        if(empty($errors)==true){
		 ...
		 if($db->uploadAlbumImages($file_name,$_SESSION['username'],$_GET['id'])	 > 0)
		 {
			 continue;
   ...
   if($tmp_name != '')
   {
    ...
    echo "<script language='javascript' type='text/javascript'> location.href='index.php?page=photoAlbum&id=".$_GET['id']."&msg=success' </script>";
